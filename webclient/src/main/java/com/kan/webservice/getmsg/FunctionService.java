 ...
 * 
 */
@WebServiceClient(name = "FunctionService", targetNamespace = "http://function.kan.com/", wsdlLocation = "http://localhost:9001/Service/Function?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://function.kan.com/", "FunctionService");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://function.kan.com/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://function.kan.com/", "FunctionPort"), Function.class, features);
    }
